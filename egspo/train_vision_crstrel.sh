...
LEARNING_RATE=3e-5
LOGPS_EVAL="unbiased"
LOGPS_EVAL_STEP_SELECTION="critical_confidence"
EPSILON=0.5
EPSILON_HIGH=0.5
TEMPERATURE=0.9
LAMBDA1=0.0
...
# Derived run name
# ============================================
RUN_NAME="crstrel_${LOGPS_EVAL_STEP_SELECTION}_${DATASET}_eps_${EPSILON}_epshigh_${EPSILON_HIGH}_temp_${TEMPERATURE}_ng${NUM_GENERATIONS}_bs${PER_DEVICE_TRAIN_BATCH_SIZE}_ga${GRAD_ACCUMULATION_STEPS}_le${LOGPS_EVAL_NUM_STEPS}_lr${LEARNING_RATE}_kl${BETA}_logps_aggregation_${LOGPS_AGGREGATION}"

...
# Custom imports
from epsa_trainer_dream import EPSATrainer
...
def main(grpo_config, model_config):
    ...
    # DreamModel doesn't implement prepare_inputs_for_generation (required by PEFT's PeftModelForCausalLM)
    ...
    assert mask_id is not None, "DREAM tokenizer must have a mask_token_id"
    print(f"Using mask_id={mask_id}", flush=True)
    ...
    trainer = EPSATrainer(
        ...
        processing_class=tokenizer, ##new
    )
